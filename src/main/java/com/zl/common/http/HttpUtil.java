...
public class HttpUtil {
    ...
    public static void doGet(String url, Map<String, String> params, Map<String, String> heardes, HttpCallBack callBack) {
        String reqUrl = url;
        if (params != null && params.size() > 0) { reqUrl = reqUrl + "?" + parseUrlRequest(params); }
        Request.Builder builder = new Request.Builder();
        builder.url(reqUrl);
        if (heardes != null && heardes.size() > 0) { builder.headers(getHeards(heardes)); }
        request(builder.build(), callBack);
    }

    public static <T> T doGet(String url, Map<String, String> params, Map<String, String> heardes, TypeReference<T> type) {
        String reqUrl = url;
        if (params != null && params.size() > 0) { reqUrl = reqUrl + "?" + parseUrlRequest(params); }
        Request.Builder builder = new Request.Builder();
        builder.url(reqUrl);
    ...
    public static void requestPost(String url, RequestBody body, Map<String, String> heardes, HttpCallBack callBack) {
        Request.Builder builder = new Request.Builder();
        builder.url(url);
        if (heardes != null && heardes.size() > 0) { builder.headers(getHeards(heardes)); }
        builder.post(body);
    ...
    public static <T> T requestPost(String url, RequestBody body, Map<String, String> heardes, TypeReference<T> type) {
        Request.Builder builder = new Request.Builder();
        builder.url(url);
        if (heardes != null && heardes.size() > 0) { builder.headers(getHeards(heardes)); }
        builder.post(body);
    ...
    public static Headers getHeards(Map<String, ?> heardes) {
        Headers.Builder builder = new Headers.Builder();
        for (Map.Entry<String, ?> entry : heardes.entrySet()) {
